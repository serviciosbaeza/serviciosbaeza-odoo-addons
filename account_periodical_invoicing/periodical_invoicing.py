...
class agreement(osv.osv):
    ...
    def create_invoice(self, cr, uid, agreement, agreement_lines, context={}):
        ...
        invoice = {
            ...
            'journal_id': account.invoice.account_invoice._get_journal(invoice_obj, cr, uid, context),
            'type': 'out_invoice',
            'state': 'draft',
            'currency_id': account.invoice.account_invoice._get_currency(invoice_obj, cr, uid, context),
        ...
        invoice.update(account.invoice.account_invoice.onchange_partner_id(invoice_obj, cr, uid, [], type=invoice['type'], partner_id=agreement.partner_id.id)['value'], company_id=agreement.company_id.id, context=context)                   
        ...
        for agreement_line in agreement_lines.keys():
            ...
            invoice_line.update(account.invoice.account_invoice_line.product_id_change(invoice_line_obj, cr, uid, [], \
